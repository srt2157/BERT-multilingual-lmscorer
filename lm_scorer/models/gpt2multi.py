...
from lm_scorer import multilingual_paths

class MULTIGPT2LMScorer(TransformersLMScorer):
    # @overrides
    def _build(self, model_name: str, options: Dict[str, Any]) -> None:
        super()._build(model_name, options)

        self.tokenizer = AutoTokenizer.from_pretrained(multilingual_paths.model_id)
        ...
        print(multilingual_paths.model_id + " is used")
        self.model = AutoModelWithLMHead.from_pretrained(multilingual_paths.model_id)
